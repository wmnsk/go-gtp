...
func handleCreateSessionRequest(s11Conn *v2.Conn, mmeAddr net.Addr, msg message.Message) error {
...
func handleModifyBearerRequest(s11Conn *v2.Conn, mmeAddr net.Addr, msg message.Message) error {
	sgw.loggerCh <- fmt.Sprintf("Received %s from %s", msg.MessageTypeName(), mmeAddr)
	...
	mbRspFromSGW := message.NewModifyBearerResponse(
		...
		ie.NewBearerContext(
			...
			ie.NewFullyQualifiedTEID(v2.IFTypeS1USGWGTPU, s1usgwTEID, s1uIP, ""),
		),
	)
...
func handleDeleteSessionRequest(s11Conn *v2.Conn, mmeAddr net.Addr, msg message.Message) error {
	sgw.loggerCh <- fmt.Sprintf("Received %s from %s", msg.MessageTypeName(), mmeAddr)
...
func handleDeleteBearerResponse(s11Conn *v2.Conn, mmeAddr net.Addr, msg message.Message) error {
	sgw.loggerCh <- fmt.Sprintf("Received %s from %s", msg.MessageTypeName(), mmeAddr)
...
func handleFTEIDU(fteiduIE *ie.IE, session *v2.Session, bearer *v2.Bearer) error {
